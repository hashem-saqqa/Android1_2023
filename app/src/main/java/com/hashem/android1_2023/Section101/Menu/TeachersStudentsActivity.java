...
import com.hashem.android1_2023.Section101.ARL.StudentActivity;
import com.hashem.android1_2023.Section101.ARL.TeacherActivity;
import com.hashem.android1_2023.databinding.ActivityTeachersStudentsBinding;

public class TeachersStudentsActivity extends AppCompatActivity {
    ActivityTeachersStudentsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityTeachersStudentsBinding.inflate(getLayoutInflater());
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.addStudentItem){
            launcher.launch(new Intent(getApplicationContext(), StudentActivity.class));
            return true;
        }else if(item.getItemId() == R.id.addTeacherItem){
