...
public class MyDatabase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL("CREATE TABLE "+CONTACTS_TABLE+" ("+ID_COLUMN+" integer primary key autoincrement,"
                +NAME_COLUMN+" text, "+EMAIL_COLUMN+" text, "+PHONE_COLUMN+" text, "+YEAR_OF_BIRTH_COLUMN+" integer)");
    ...
    public int deleteContact(int id){
        ...
        int result = db.delete(CONTACTS_TABLE," id = ?",args);
        return result;
    }
    public int updateContact(Contact contact){
        ...
        int result = db.update(CONTACTS_TABLE,cv,"id = ?",new String[]{String.valueOf(contact.getId())});
